    ...
    for pro = 5:length(problems)
        ...
        for ri = 1:3
            ...
            if (op_debug)
                ...
                Global = GLOBAL('-algorithm', @MOEAD, '-problem', problems{pro}, '-operator', @CSAreal, '-N', pop_size,  '-evaluation', (eNum*tao_t+pre)*pop_size, '-mode', 3, '-MOEAD_parameter', {ri, s, tao_t, pre, 1, 0, 1});
        ...
        %     labindex = 3;
            ...
            dlmwrite('./Data/Result/EX10/moead.csv', data);
            dlmwrite('./Data/Result/EX10/moead_details.csv', details);
